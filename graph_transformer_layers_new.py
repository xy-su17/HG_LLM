...
class MultiHeadAttentionLayer(nn.Module):
    def __init__(self, in_dim, out_dim, num_heads, use_bias=True):
        ...
        num_steps = 6
        max_edge_types = 12
        self.feature_Q = RelGraphConv(in_feat=in_dim, out_feat=in_dim, num_rels=11, regularizer='basis', num_bases=11,
                                      activation=f.relu, dropout=0.1)  
        self.feature_K = RelGraphConv(in_feat=in_dim, out_feat=in_dim, num_rels=11, regularizer='basis', num_bases=11,
                                      activation=f.relu, dropout=0.1)
        self.feature_V = RelGraphConv(in_feat=in_dim, out_feat=in_dim, num_rels=11, regularizer='basis', num_bases=11,
                                      activation=f.relu, dropout=0.1)
...
class GraphTransformerLayer(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, max_edge_types, num_heads, dropout=0.3, layer_norm=False,
